...
export const properties = [
  {
    ...
    description:
      'A stunning 4-bedroom, 3-bathroom villa in a peaceful suburban neighborhood, highlighting a private swimming pool, landscaped garden, and sun-drenched terraces. Designed with a sleek minimalist aesthetic, it offers the ultimate retreat for contemporary indoor-outdoor living.',
    image: 'property-1',
    details: {
      bedrooms: 4,
      bathrooms: 3,
  ...
  },
  {
    ...
    description:
      'A chic and fully-furnished 2-bedroom apartment with panoramic city views, boasting floor-to-ceiling windows, high-end designer finishes, and a spacious balcony. Located in a luxury high-rise with access to a rooftop pool, private gym, and 24/7 concierge service.',
    image: 'property-2',
    details: {
      bedrooms: 2,
      bathrooms: 2,
  ...
  },
  {
    ...
    description:
      'An elegant 3-bedroom, 2.5-bathroom townhouse in a gated community, featuring an open-concept living area, modern kitchen with premium appliances, and a private cozy backyard. Perfect for families seeking comfort, security, and a vibrant neighborhood atmosphere.',
    image: 'property-3',
    details: {
      bedrooms: 3,
      bathrooms: 3,
  ...
  },
  {
    ...
    description:
      'An exquisite 3-bedroom, 2-bathroom penthouse located in the heart of the downtown area, boasting floor-to-ceiling windows, a panoramic rooftop deck, and premium smart-home integration. This residence offers unmatched skyline views and high-end finishes for sophisticated urban living.',
    image: 'property-1',
    details: {
      bedrooms: 3,
      bathrooms: 2,
  ...
  },
  {
    ...
    description:
      'A charming 5-bedroom, 4-bathroom mountain lodge nestled among mature pine forests, featuring an open-concept timber frame design, a massive stone fireplace, and an outdoor hot tub. Perfect as a cozy winter sanctuary or a serene year-round nature escape.',
    image: 'property-2',
    details: {
      bedrooms: 5,
      bathrooms: 4,
  ...
  },
  {
    ...
    description:
      'A compact yet luxuriously appointed 1-bedroom, 1-bathroom coastal apartment with direct access to sandy shores. Features include private balcony seating, brilliant natural lighting, and space-saving modern furniture tailored for maximum comfort and an effortless seaside lifestyle.',
    image: 'property-3',
    details: {
      bedrooms: 1,
      bathrooms: 1,
...
export const propertiesContact = {
  textFields: [
    {
      id: 'first-name',
      label: 'First Name',
